...
//import chunson.cc.carket.utils.PswHashUtils;
...
//    {
//        return Result.ok(userMapper.getUserById(userId), null);
//    }
//
...
//        }
//
//        if (!PswHashUtils.md5Password(password).equals(user.getPassword()))
//        {
//            return Result.failure("密码错误");
//        }
//
//        return Result.ok(tokenUtils.generateToken(user), null);
//    }
//
...
//        String password = req.get("password");
//        String code = req.get("code");
//        String md5Password = PswHashUtils.md5Password(password);
//
...
//
//        User user = userMapper.getUserByPhone(phone);
//        return Result.ok(user.getUserId(), null);
//    }
//
...
//    {
//        String token = request.getHeader("token");
//        return Result.ok(tokenUtils.refreshToken(token), null);
//    }
//}